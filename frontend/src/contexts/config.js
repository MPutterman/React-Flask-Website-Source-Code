...
export const initialState = {
    general: {
        ...
        user_thumbnail_blank_url: '/images/user_thumbnail_blank.png',
        user_avatar_blank_url: '/images/user_avatar_blank.png',
        org_thumbnail_blank_url: '/images/org_thumbnail_blank.png',
    },
    search: {
